...
import { DownOutlined, LogoutOutlined, UserOutlined, PhoneOutlined } from '@ant-design/icons';
                ...
                visible ? (
                    <>
                        ...
                        <Menu
                            ...
                            onClick={() => toggle()}
                        >
                            <Menu.Item className={style.username}>
                                <span>用户名: {store.username}</span>
                            </Menu.Item>
                            <SubMenu icon={<UserOutlined />} title="用户中心">
                                <Menu.Item>
                                    <NavLink to='/update-pwd'>修改密码</NavLink>
                                </Menu.Item>
                                <Menu.Item>
